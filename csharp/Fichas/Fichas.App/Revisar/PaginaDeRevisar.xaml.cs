...
public sealed partial class PaginaDeRevisar : PaginaDeFichas
{
    ...
    /// </summary>
    /// <remarks>
    /// ⛔ <b>Los archivados NO entran</b>, y por eso se pide con <c>conArchivados: false</c>.
    /// Del dueno, 2026-09-05: «cuando yo archive, debe salir del sistema visible, pero se
    /// queda como historico para los reportes». Archivar sigue sin borrar: el caso entero
    /// se queda en la base, cuenta en los reportes y sale en el historico; lo unico que
    /// cambia es que deja de estorbar aqui.
    /// </remarks>
